...
\begin{document}
\prob{1}{See code. Filename: * line number: *.}
...
\prob{2}{}
	\begin{figure}[h!]
		...
		\begin{tabular}{lll}
			...
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox75_5.pdf}
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox75_10.pdf}\vspace{-3mm}
			\\
			...
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox120_5.pdf}
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox120_10.pdf}\vspace{-3mm}
			\\
			...
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox150_5.pdf}
			&
			\hspace{-4mm}\includegraphics[width=0.35\textwidth]{figs/3SpeciesApprox150_10.pdf}\vspace{-3mm}
			\\
